...
public class UserPage {
	...
	//Emgcontact
	@FindBy(xpath = "//a[@href='/user/emergency-contacts']") WebElement emgConc;
	@FindBy(xpath = "//input[@placeholder='Name of your contact']") WebElement emgName;
	@FindBy(xpath = "//input[@placeholder='Enter phone number']") WebElement phoneNumber;
	@FindBy(xpath = "//button[@class='add-number']") WebElement plusIcon;
	@FindBy(xpath = "//a[@class='dail mr-1']") WebElement editicn;
	@FindBy(xpath = "//a[@class='dail']") WebElement delIcon;
	@FindBy(xpath = "//button[normalize-space()='Ok']") WebElement deletContact;
	
	//Directory
	@FindBy(xpath = "//a[@href='/user/directory']") WebElement directory;
	@FindBy(xpath = "//div[@class='ngx-select__toggle btn form-control']") WebElement selectCity;
	@FindBy(xpath = "//input[@placeholder='Select City']") WebElement cityList;
	@FindBy(xpath = "//div[@class='toast-success ngx-toastr ng-trigger ng-trigger-flyInOut']") WebElement srcConfig;
	...
	public void amIAtRrisk() {
		...
		WebElement message = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[text()=' User questionaires added successfully ']")));
